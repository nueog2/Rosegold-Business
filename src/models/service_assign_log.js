...
class ServiceAssignLog {
          ...
          include: [
            {
              ...
              attributes: ["id", "name", "service_category_id"],
            },
          ],
          where: condition,
        })
      ...
      models.service_assign_log
        .findAll({
          include: [
            {
              model: models.service,
              attributes: ["id", "name", "purpose", "service_category_id"],
            },
          ],
          where: condition,
        })
  ...
  delete(service_assign_log_id) {
    return new Promise((resolve, reject) => {
      this.readOne({ id: service_assign_log_id })
        .then((response) => {
          models.service_assign_log
            .destroy({
              where: {
